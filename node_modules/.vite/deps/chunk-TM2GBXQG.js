...
import {
  init_useForkRef,
  useForkRef_default
} from "./chunk-SGCX36P7.js";
import {
  capitalize_default,
  init_capitalize
} from "./chunk-MRMUQUBF.js";
import {
  HTMLElementType,
  _extends,
...
var Paper = React72.forwardRef(function Paper2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPaper"
  });
  ...
  return (0, import_jsx_runtime51.jsx)(PaperRoot, _extends({
    as: component,
    ownerState,
...
var Dialog = React73.forwardRef(function Dialog2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiDialog"
  });
  ...
  const backdropClick = React73.useRef();
  const handleMouseDown = (event) => {
  ...
  const dialogContextValue = React73.useMemo(() => {
    return {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-TM2GBXQG.js.map
